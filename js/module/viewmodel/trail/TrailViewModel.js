 ...
 define([
 	...
 	function(
 		...
 		var Module = function() {
 			...
 			self.googleMapUrl = ko.observable("https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=ladakh&amp;aq=&amp;sll=12.953997,77.63094&amp;sspn=0.722701,1.263428&amp;ie=UTF8&amp;hq=&amp;hnear=Ladakh+Range&amp;ll=34,78&amp;spn=1.230924,2.526855&amp;t=m&amp;z=9&amp;output=embed");
			...
			self.uploadTrail = function() {
				...
				$.ajax({
	        url: 'http://indiahikes-api.jelastic.servint.net/api/upload/',
	        type: 'POST',
